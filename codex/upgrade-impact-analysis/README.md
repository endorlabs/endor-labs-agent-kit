# Endor Labs Upgrade Impact Analysis Codex Skill
...
This is the Codex generated skill for `upgrade-impact-analysis`.

| Reader | First move |
| --- | --- |
| Human operator | Copy this generated skill directory into `$HOME/.agents/skills/` and start a new Codex session. Then use the example prompt below: Use the upgrade-impact-analysis skill to help with this Endor Labs workflow. |
