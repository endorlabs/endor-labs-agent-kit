...
- Never edit files, run dependency-manager mutation commands, push branches, open PRs/MRs, or post comments without explicit user approval in the Codex session.
