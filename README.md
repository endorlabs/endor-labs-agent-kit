...
| ☁️ Gemini Enterprise service | Hand-written A2A SCA Remediation service for the Gemini Enterprise Marketplace (not generated; distinct from `gemini/`) | [`gemini-enterprise/README.md`](gemini-enterprise/README.md) |
...
Current generated plugin package version: `2.2.2`.
...
| Work on the Gemini Enterprise A2A service | `gemini-enterprise/README.md` (hand-written, not generated) | `source/`, `src/`, generated host directories |
