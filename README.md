...
| Universal Plugins Directory | Eleven skills using the active customer model in ChatGPT and Codex | Install the reviewed skills-only artifact generated from `plugins/codex-directory/endor-labs-agent-kit/`. |
