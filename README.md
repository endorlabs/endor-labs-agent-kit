...
| Endor Labs Upgrade Impact Analysis | Compare current and target versions before a dependency upgrade | `claude-code/upgrade-impact-analysis/` | `claude-managed-agents/upgrade-impact-analysis/` |
