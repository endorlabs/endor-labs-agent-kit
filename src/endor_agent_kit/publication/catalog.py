...
def _agent_safety(agent_id: str) -> str:
    mutating = {"ai-sast-triage", "sca-remediation"}
...
def _agent_first_prompt(agent_id: str) -> str:
    prompts = {
        ...
        "repository-dependency-reviewer": "Review this repository's dependency manifests with read-only evidence only.",
        ...
        "upgrade-impact-analysis": "Show the safest upgrade path for repository <owner>/<repo> package lodash. Keep it read-only.",
