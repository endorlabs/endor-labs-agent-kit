# Endor Labs Repository Dependency Reviewer Portable Agent Bundle
...
This is the portable runtime generated agent bundle for `repository-dependency-reviewer`.
...
```bash
endor-agent-kit check-install --host portable --agent repository-dependency-reviewer --portable-dir /path/to/runtime/agents/repository-dependency-reviewer
```
