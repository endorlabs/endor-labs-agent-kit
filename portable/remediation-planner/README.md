# Remediation Planner Portable Agent Bundle
...
```bash
endor-agent-kit check-install --host portable --agent remediation-planner --portable-dir /path/to/runtime/agents/remediation-planner
```
