# AI SAST Triage Portable Agent Bundle
...
```bash
endor-agent-kit check-install --host portable --agent ai-sast-triage --portable-dir /path/to/runtime/agents/ai-sast-triage
```
