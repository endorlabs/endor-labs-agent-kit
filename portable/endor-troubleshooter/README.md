# Endor Troubleshooter Portable Agent Bundle
...
```bash
endor-agent-kit check-install --host portable --agent endor-troubleshooter --portable-dir /path/to/runtime/agents/endor-troubleshooter
```
