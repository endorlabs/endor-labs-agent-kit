...
- `evidence_queries` (list[object], required): Current Endor, repository, and local source evidence queries used for the remediation decision, including skipped or failed Finding and VersionUpgrade/UIA lookups.
