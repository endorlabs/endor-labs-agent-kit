...
- `dependency_graph_audit` (`object`): Bounded Maven audit of graph manipulations on the selected dependency path, including direct overrides, exclusions, exact replacements, evidence status, and required graph/runtime validation.
