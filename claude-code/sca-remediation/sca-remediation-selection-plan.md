...
string: `summary`; object: `project_resolution`, `selected_remediation`, `risk_decision`, `policy_context`; list[object]: `evidence_queries`, `uia_evidence`, `change_requests`, `policy_evaluations`; list[string]: `data_gaps`
