...
enum: `profile`, `risk_posture`; list[object]: `findings`, `evidence_queries`, `policy_evaluations`; list[string]: `strengths`, `next_checks`, `data_gaps`; string: `summary`; object: `policy_context`
