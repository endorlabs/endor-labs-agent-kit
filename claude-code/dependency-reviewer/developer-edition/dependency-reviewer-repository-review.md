---
name: dependency-reviewer-repository-review
description: |
...
`profile`, `risk_posture`, `manifests`, `dependencies_reviewed`, `findings`, `recommended_actions`, `summary`, `evidence_queries`, `data_gaps`, `policy_context`, `policy_evaluations`
