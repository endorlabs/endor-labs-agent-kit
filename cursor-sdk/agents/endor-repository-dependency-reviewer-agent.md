...
<!-- endor_agent_kit_managed=true agent_id=repository-dependency-reviewer agent_name=endor-repository-dependency-reviewer-agent host=cursor-sdk -->

Generated from Endor Agent Kit recipe `repository-dependency-reviewer` v1.0.0 for Cursor Python SDK automation.
