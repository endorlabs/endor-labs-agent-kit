...
<!-- endor_agent_kit_managed=true agent_id=remediation-planner agent_name=endor-remediation-planner-agent host=cursor-sdk -->

Generated from Endor Agent Kit recipe `remediation-planner` v0.1.0 for Cursor Python SDK automation.
