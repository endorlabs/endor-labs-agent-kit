...
<!-- endor_agent_kit_managed=true agent_id=package-risk-summary agent_name=endor-package-risk-summary-agent host=cursor-sdk -->

Generated from Endor Agent Kit recipe `package-risk-summary` v1.0.0 for Cursor Python SDK automation.
