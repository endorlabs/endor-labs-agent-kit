...
<!-- endor_agent_kit_managed=true agent_id=upgrade-impact-analysis agent_name=endor-upgrade-impact-analysis-agent host=cursor-sdk -->

Generated from Endor Agent Kit recipe `upgrade-impact-analysis` v1.0.0 for Cursor Python SDK automation.
