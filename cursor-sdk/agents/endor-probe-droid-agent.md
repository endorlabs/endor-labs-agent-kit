...
<!-- endor_agent_kit_managed=true agent_id=probe-droid agent_name=endor-probe-droid-agent host=cursor-sdk -->

Generated from Endor Agent Kit recipe `probe-droid` v0.1.0 for Cursor Python SDK automation.
