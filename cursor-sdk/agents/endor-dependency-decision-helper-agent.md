...
<!-- endor_agent_kit_managed=true agent_id=dependency-decision-helper agent_name=endor-dependency-decision-helper-agent host=cursor-sdk -->

Generated from Endor Agent Kit recipe `dependency-decision-helper` v1.0.0 for Cursor Python SDK automation.
