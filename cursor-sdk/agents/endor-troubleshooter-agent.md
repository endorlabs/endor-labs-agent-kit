...
<!-- endor_agent_kit_managed=true agent_id=endor-troubleshooter agent_name=endor-troubleshooter-agent host=cursor-sdk -->

Generated from Endor Agent Kit recipe `endor-troubleshooter` v0.1.0 for Cursor Python SDK automation.
