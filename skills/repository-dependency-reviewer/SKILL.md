...
<!-- endor_agent_kit_managed=true agent_id=repository-dependency-reviewer host=cursor -->

# Endor Labs Repository Dependency Reviewer

Generated from Endor Agent Kit recipe `repository-dependency-reviewer` v1.0.0 for the Endor Labs Agent Kit Cursor package.
