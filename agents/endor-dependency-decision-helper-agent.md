---
name: endor-dependency-decision-helper-agent
description: |
...
<!-- endor_agent_kit_managed=true agent_id=dependency-decision-helper agent_name=endor-dependency-decision-helper-agent host=cursor -->

# Dependency Decision Helper

Generated from Endor Agent Kit recipe `dependency-decision-helper` v1.0.0 for the Endor Labs Agent Kit Cursor plugin agent.
Treat this as a source-first generated artifact; update the recipe and
republish instead of hand-editing installed copies.

This plugin also ships the matching support skill `skills/dependency-decision-helper/`.
