# Remediation Planner Gemini CLI Bundle

Preview safe remediation options without opening PRs.

## Start Here

This is the Gemini CLI generated skill and subagent bundle for `remediation-planner`.

| Reader | First move |
| --- | --- |
| Human operator | Prefer the generated Gemini extension under `plugins/gemini/endor-labs-agent-kit`, then restart Gemini CLI. Then use the example prompt below: Use @remediation-planner to help with this Endor Labs workflow. |
...
```text
Use @remediation-planner to help with this Endor Labs workflow.
```
