...
Generated from Endor Agent Kit recipe `oss-upgrade-investigator` v1.0.0 for Gemini CLI.
...
In Gemini CLI, read the repository root and `origin` remote URL, then resolve the matching
