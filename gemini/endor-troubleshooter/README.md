# Endor Troubleshooter Gemini CLI Bundle
...
```text
Use @endor-troubleshooter to diagnose this Endor issue from redacted error text and read-only tenant evidence. Keep the workflow read-only.
```
