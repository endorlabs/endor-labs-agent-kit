# Endor Labs Package Risk Summary Gemini CLI Bundle
...
This is the Gemini CLI generated skill and subagent bundle for `package-risk-summary`.

| Reader | First move |
| --- | --- |
| Human operator | Prefer the generated Gemini extension under `plugins/gemini/endor-labs-agent-kit`, then restart Gemini CLI. Then use the example prompt below: Use @package-risk-summary to help with this Endor Labs workflow. |
...
```text
Use @package-risk-summary to help with this Endor Labs workflow.
```
