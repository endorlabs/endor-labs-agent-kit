...
<!-- endor_agent_kit_managed=true agent_id=remediation-planning profile_id=evidence-check host=claude-code-plugin -->
...
`summary`, `project_resolution`, `evidence_queries`, `remediation_options`, `data_gaps`, `policy_context`, `policy_evaluations`
