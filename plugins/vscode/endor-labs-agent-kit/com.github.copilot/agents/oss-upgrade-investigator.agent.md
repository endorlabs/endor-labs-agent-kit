...
<!-- endor_agent_kit_managed=true agent_id=oss-upgrade-investigator host=vscode -->

# OSS Upgrade Investigator

Generated from Endor Agent Kit recipe `oss-upgrade-investigator` v1.0.0 for Endor Labs Agent Kit Copilot agent plugin subagent.
