...
Generated from Endor Agent Kit recipe `remediation-planning` v0.1.0 for Endor Labs Agent Kit Copilot agent plugin.
...
URL, Endor project name, finding UUID, or optional project UUID. In VS Code,
