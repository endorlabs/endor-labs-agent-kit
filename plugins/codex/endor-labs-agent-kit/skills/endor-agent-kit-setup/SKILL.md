...
<!-- endor_agent_kit_managed=true agent_id=endor-agent-kit-setup host=codex package=endor-labs-agent-kit version=2.2.2 -->

# Endor Agent Kit Setup For Codex

Generated for Endor Labs Agent Kit Codex plugin `endor-labs-agent-kit` v2.2.2.
