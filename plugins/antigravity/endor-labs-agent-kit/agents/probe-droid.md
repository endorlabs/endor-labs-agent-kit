...
<!-- endor_agent_kit_managed=true agent_id=probe-droid host=antigravity -->

# Probe Droid

Generated from Endor Agent Kit recipe `probe-droid` v0.1.0 for Endor Labs Agent Kit Antigravity CLI plugin subagent.
