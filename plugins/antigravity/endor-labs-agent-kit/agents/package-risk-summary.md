...
<!-- endor_agent_kit_managed=true agent_id=package-risk-summary host=antigravity -->

# Endor Labs Package Risk Summary

Generated from Endor Agent Kit recipe `package-risk-summary` v1.0.0 for Endor Labs Agent Kit Antigravity CLI plugin subagent.
