...
<!-- endor_agent_kit_managed=true agent_id=dependency-decision-helper host=antigravity -->

# Dependency Decision Helper

Generated from Endor Agent Kit recipe `dependency-decision-helper` v1.0.0 for Endor Labs Agent Kit Antigravity CLI plugin subagent.
