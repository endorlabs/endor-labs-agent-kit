...
Generated from Endor Agent Kit recipe `upgrade-impact-analysis` v1.0.0 for Endor Labs Agent Kit Gemini CLI extension.
...
In Gemini CLI, first use the current repository context when it is available:
